...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-8db945bc_0", {
    source: ".tools[data-v-8db945bc]{height:30px;padding:5px 10px;background:#333;border-radius:3px;position:absolute;top:0;left:0;transform:translate(-50%,-100%);transition:.2s all;display:flex;justify-content:center;align-items:center}.tools[data-v-8db945bc]:after{content:\"\";position:absolute;left:50%;bottom:-5px;transform:translateX(-50%);width:0;height:0;border-left:6px solid transparent;border-right:6px solid transparent;border-top:6px solid #333}.item[data-v-8db945bc]{color:#fff;cursor:pointer}.item>svg>path[data-v-8db945bc]{fill:#fff}.item:hover>svg>path[data-v-8db945bc]{fill:#19f}.item[data-v-8db945bc]:hover{color:#19f}.item[data-v-8db945bc]{margin:0 5px}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-8db945bc";
/* module identifier */
